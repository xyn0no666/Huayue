(function(){
  ...
  var DICT = {
    zh: {
      ...
      'factory.card4.title':'准时交付','factory.card4.desc':'ERP排产管理，订单按期交付。',
      ...
      'section.certs':'厂家直发','section.certs.sub':'源头工厂直供，无中间商，价格与品质更有保障',
      ...
      'brand.timeline.2026.title':'鼎盛稳定期','brand.timeline.2026.desc':'现阶段的工厂成熟发展阶段，41,334㎡的规模化厂区，全套生产设备，专业团队，形成了业务一体化的完整产业体系。',
      'brand.factory.tag':'Manufacturing Excellence','brand.factory.title':'制造实力，看得见的品质','brand.factory.desc1':'41,000㎡现代化厂区，涵盖冲压、焊接、涂装、注塑、电机、总装等主要车间，多条流水装配线，满足大订单需求。','brand.factory.desc2':'我们拥有覆盖尺寸、材质、盐雾、耐久等关键指标的检测设备。每款产品出厂前需经过来料检验、过程巡检、成品全检三道关口。',
      'brand.factory.stat1':'年制造经验','brand.factory.stat2':'大产品系列','brand.factory.stat3':'㎡ 厂区面积',
      ...
      'brand.qcard2.title':'研发与模具能力','brand.qcard2.desc':'专业研发团队，自主模具加工中心，可快速完成从设计到样机的全流程开发，持续推出新品。',
      ...
      'brand.vcard3.title':'准时交付','brand.vcard3.desc':'ERP生产管理系统排产，订单进度实时追踪，旺季产能预留服务保障老客户。',
      'brand.vcard4.title':'全球服务','brand.vcard4.desc':'英语、德语、日语、西班牙语外贸团队，售后备件充足，全球快递可达。',
      ...
      'brand.company.fullname.val':'华悦园林机械','brand.company.est.val':'2008年','brand.company.addr.val':'山东省临沂市罗庄区休闲垂钓园东北200米（银杏路东）','brand.company.area.val':'41,334 平方米','brand.company.staff.val':'专业团队','brand.company.capacity.val':'规模化产能',
    ...
    en: {
      ...
      'factory.card4.title':'On-Time Delivery','factory.card4.desc':'ERP production scheduling, on-time order delivery.',
      ...
      'section.certs':'Direct from Factory','section.certs.sub':'Direct from our source factory, no middlemen, better price and quality',
      ...
      'brand.timeline.2026.title':'Established Excellence (2026)','brand.timeline.2026.desc':'Today the factory operates at mature scale — 41,334m² facility, full production equipment, a professional team, forming a complete integrated business system.',
      'brand.factory.tag':'Manufacturing Excellence','brand.factory.title':'Visible Quality, Tangible Strength','brand.factory.desc1':'41,000m² modern facility with key workshops: stamping, welding, coating, injection molding, motor, and final assembly. Multiple assembly lines, meeting large-order demands.','brand.factory.desc2':'We operate dedicated testing equipment covering dimensions, materials, salt spray, and durability. Every product passes three quality gates: incoming inspection, in-process patrol, and final full inspection.',
      'brand.factory.stat1':'Years of Manufacturing','brand.factory.stat2':'Product Lines','brand.factory.stat3':'m² Facility',
      ...
      'brand.qcard2.title':'R&D & Tooling Capability','brand.qcard2.desc':'A dedicated engineering team, in-house mold machining center. Rapid development from design to prototype, with a steady stream of new models.',
      ...
      'brand.vcard3.title':'On-Time Delivery','brand.vcard3.desc':'ERP production management with real-time order tracking; peak-season capacity reservation for loyal customers.',
      'brand.vcard4.title':'Global Service','brand.vcard4.desc':'Trade team fluent in English, German, Japanese, and Spanish. Ample after-sales spare parts shipped worldwide.',
      ...
      'brand.company.fullname.val':'Huayue Garden Machinery','brand.company.est.val':'2008','brand.company.addr.val':'200m NE of Leisure Fishing Garden, Luozhuang District, Linyi, Shandong, China (east of Yinxing Road)','brand.company.area.val':'41,334 m²','brand.company.staff.val':'Professional team','brand.company.capacity.val':'Scale production',
