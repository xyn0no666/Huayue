(function(){
  ...
  var DICT = {
    zh: {
      ...
      'factory.card4.title':'准时交付','factory.card4.desc':'ERP排产管理，交付准时率98%以上。',
    ...
    en: {
      ...
      'factory.card4.title':'On-Time Delivery','factory.card4.desc':'ERP production scheduling, 98%+ on-time delivery rate.',
