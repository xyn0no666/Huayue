(function(){
  ...
  var DICT = {
    zh: {
      // Meta
      'meta.index.title':'华悦园林 — 专业园林机械制造商 | 源头工厂','meta.index.desc':'华悦园林 — 专业园林机械制造商，割灌机、油锯、吹风机源头工厂。20年OEM/ODM经验，产品出口50+国家，欢迎全球客户询盘合作。',
      // Nav
      ...
      // Footer
      'footer.brand.desc':'专业园林机械制造商，源头工厂，20年OEM/ODM经验，产品出口50+国家，年产能20万台。欢迎全球客户合作。',
      ...
      'footer.contact.tel':'0579-8722-8888','footer.contact.email':'export@huayueyuanlin.com','footer.contact.inquiry':'在线询盘','footer.contact.dealer':'经销商门户',
      'footer.copyright':'© 2026 华悦园林 — 永康华悦园林机械有限公司',
      // Home hero
      'hero.tag1':'Made in China · Sold Worldwide','hero.title1':'专业园林机械<br>制造商','hero.desc1':'源头工厂，20年OEM/ODM经验，年产20万台，出口50+国家',
      'hero.tag2':'Precision Engineering','hero.title2':'精工铸械<br>匠心造机','hero.desc2':'深耕园林机械领域，以严苛工艺打磨每一台设备，坚守品质初心，精研性能细节',
      'hero.tag3':'Factory Direct · Wholesale Price','hero.title3':'源头供货<br>合作共赢','hero.desc3':'41,000㎡现代化工厂，CE/GS/EPA认证齐全，灵活OEM/ODM，低MOQ试单支持',
      ...
      'factory.card2.title':'国际认证','factory.card2.desc':'全系产品通过CE、GS (TUV)、EPA/CARB、RoHS、FCC认证，为50+国家客户提供合规保障',
      ...
      // Products page
      'products.tag':'Product Catalog','products.title':'产品中心','products.subtitle':'全系列汽油园林机械设备，2冲程/4冲程双动力平台，CE/EPA国际认证，支持OEM/ODM定制',
      ...
      // Brand page
      'brand.tag':'Made in China · Sold Worldwide','brand.title':'专业园林机械制造商','brand.subtitle':'20年专注，从中国永康到全球50+国家——我们以精益制造赢得信任',
      'brand.timeline':'发展历程','brand.timeline.sub':'从小型加工厂到年产能20万台的现代化制造商',
      ...
      'brand.qcard1.title':'ISO 9001 品控体系','brand.qcard1.desc':'从来料检验到成品出厂的全流程质量管理，每台设备均有唯一追溯码，质量问题48小时响应。',
      'brand.qcard2.title':'研发与模具能力','brand.qcard2.desc':'20余位研发工程师，自主模具加工中心，可60天内完成从设计到样机的全流程开发，年新品开发能力15款以上。',
      'brand.qcard3.title':'供应链整合','brand.qcard3.desc':'核心零部件（发动机、电池、电机）与Honda、Samsung SDI、Nidec等国际品牌建立战略采购合作，确保关键部件品质稳定。',
      'brand.qcard4.title':'快速响应','brand.qcard4.desc':'询盘24小时内回复，样品3-5个工作日发出，常规订单25-35天交货。专职外贸团队提供英语、德语、日语、西班牙语服务。',
      'brand.why':'为什么选择我们','brand.why.sub':'全球500+客户的选择理由',
      ...
      'brand.company.fullname.val':'永康华悦园林机械有限公司','brand.company.est.val':'2008年','brand.company.addr.val':'浙江省永康市五金科技工业园 花园大道888号','brand.company.area.val':'41,334 平方米','brand.company.staff.val':'100+ 人','brand.company.capacity.val':'20 万台',
      'brand.cert':'资质认证','brand.cert.1':'ISO 9001:2015 质量管理体系','brand.cert.2':'CE Marking 欧盟安全准入','brand.cert.3':'GS (TÜV Rheinland) 德国产品安全','brand.cert.4':'EPA & CARB 美国排放标准','brand.cert.5':'RoHS 2.0 有害物质限制','brand.cert.6':'FCC 美国电磁兼容',
      'brand.partners':'合作品牌','brand.partner.1':'Honda — 发动机战略供应商','brand.partner.2':'Samsung SDI — 电池战略供应商','brand.partner.3':'Nidec — 电机战略供应商','brand.partner.4':'全球 50+ 国家/地区客户','brand.partner.5':'500+ 家稳定合作客户',
      ...
      'contact.phone':'0579-8722-8888','contact.phone.label':'服务热线','contact.phone.hours':'周一至周六 8:00 - 18:00 (GMT+8)',
      'contact.email.label':'电子邮箱','contact.email.hint':'外贸团队24小时内回复',
      'contact.addr.label':'工厂地址','contact.addr.hint':'距义乌机场40分钟 / 义乌高铁站35分钟',
      ...
      'support.search':'搜索问题...（如：OEM / MOQ / 保修 / 认证）',
      ...
      'dealer.resetPassword':'请联系外贸经理重置密码，邮箱: export@huayueyuanlin.com',
      'dealer.partner':'合作伙伴',
    ...
    en: {
      // Meta
      'meta.index.title':'Huayue Garden — Professional Garden Machinery Manufacturer | Source Factory','meta.index.desc':'Huayue Garden — Professional garden machinery manufacturer. Brush cutters, chainsaws, and blowers direct from the source factory. 20 years OEM/ODM experience, exporting to 50+ countries. Contact us for cooperation.',
      // Nav
      ...
      // Footer
      'footer.brand.desc':'Professional garden machinery manufacturer, source factory with 20 years OEM/ODM experience, exporting to 50+ countries with annual capacity of 200,000 units. Welcome global cooperation.',
      ...
      'footer.contact.tel':'0579-8722-8888','footer.contact.email':'export@huayueyuanlin.com','footer.contact.inquiry':'Online Inquiry','footer.contact.dealer':'Dealer Portal',
      'footer.copyright':'© 2026 Huayue Garden — Yongkang Huayue Garden Machinery Co., Ltd.',
      // Home hero
      'hero.tag1':'Made in China · Sold Worldwide','hero.title1':'Professional Garden<br>Machinery Manufacturer','hero.desc1':'Source factory, 20 years OEM/ODM experience, 200K annual capacity, exported to 50+ countries',
      ...
      'hero.tag3':'Factory Direct · Wholesale Price','hero.title3':'Factory Direct<br>Win-Win Partnership','hero.desc3':'41,000m² modern factory, full CE/GS/EPA certifications, flexible OEM/ODM, low MOQ trial orders supported',
      ...
      'factory.card2.title':'Global Certifications','factory.card2.desc':'All products certified CE, GS (TUV), EPA/CARB, RoHS, and FCC — providing compliance assurance for clients in 50+ countries',
      ...
      // Products page
      'products.tag':'Product Catalog','products.title':'Products','products.subtitle':'Full range of gasoline garden machinery, 2-stroke/4-stroke dual power platforms, CE/EPA certified, OEM/ODM customization supported',
      ...
      // Brand page
      'brand.tag':'Made in China · Sold Worldwide','brand.title':'Professional Garden Machinery Manufacturer','brand.subtitle':'20 years of dedication, from Yongkang China to 50+ countries — earning trust through lean manufacturing',
      'brand.timeline':'Our Journey','brand.timeline.sub':'From a small workshop to a modern manufacturer with 200K annual capacity',
      ...
      'brand.qcard1.title':'ISO 9001 Quality System','brand.qcard1.desc':'Full-process quality management from incoming material inspection to finished product delivery. Each unit has a unique traceability code; quality issues receive 48-hour response.',
      ...
      'brand.qcard3.title':'Supply Chain Integration','brand.qcard3.desc':'Strategic procurement partnerships with Honda (engines), Samsung SDI (batteries), and Nidec (motors) ensure consistent quality of critical components.',
      ...
      'brand.why':'Why Choose Us','brand.why.sub':'Reasons chosen by 500+ global clients',
      ...
      'brand.company.fullname.val':'Yongkang Huayue Garden Machinery Co., Ltd.','brand.company.est.val':'2008','brand.company.addr.val':'888 Huayuan Avenue, Hardware Technology Industrial Park, Yongkang, Zhejiang, China','brand.company.area.val':'41,334 m²','brand.company.staff.val':'100+','brand.company.capacity.val':'200,000 units',
      'brand.cert':'Certifications','brand.cert.1':'ISO 9001:2015 Quality Management','brand.cert.2':'CE Marking — EU Safety Compliance','brand.cert.3':'GS (TÜV Rheinland) — German Product Safety','brand.cert.4':'EPA & CARB — U.S. Emission Standards','brand.cert.5':'RoHS 2.0 — Hazardous Substances Restriction','brand.cert.6':'FCC — U.S. Electromagnetic Compatibility',
      'brand.partners':'Partner Brands','brand.partner.1':'Honda — Strategic Engine Supplier','brand.partner.2':'Samsung SDI — Strategic Battery Supplier','brand.partner.3':'Nidec — Strategic Motor Supplier','brand.partner.4':'Clients in 50+ Countries/Regions','brand.partner.5':'500+ Stable Cooperative Clients',
      ...
      'contact.phone':'0579-8722-8888','contact.phone.label':'Hotline','contact.phone.hours':'Mon-Sat 8:00-18:00 (GMT+8)',
      'contact.email.label':'Email','contact.email.hint':'Trade team responds within 24 hours',
      'contact.addr.label':'Factory Address','contact.addr.hint':'40 min from Yiwu Airport / 35 min from Yiwu HSR Station',
      ...
      'support.search':'Search questions... (e.g. OEM / MOQ / warranty / certification)',
      ...
      'dealer.resetPassword':'Please contact your account manager to reset your password: export@huayueyuanlin.com',
