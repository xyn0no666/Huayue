(function(){
  ...
  var DICT = {
    zh: {
      ...
      'contact.chat.label':'在线客服','contact.chat.open':'点击开始实时聊天','contact.chat.hint':'工作时间即时回复，非工作时间留言',
    ...
    en: {
      ...
      'contact.chat.label':'Live Chat','contact.chat.open':'Click to start a live chat','contact.chat.hint':'Instant reply during work hours',
