(function(){
  ...
  var DICT = {
    zh: {
      ...
      'section.certs':'国际认证','section.certs.sub':'产品通过国际权威认证，符合欧美主流市场准入标准',
    ...
    en: {
      ...
      'section.certs':'International Certifications','section.certs.sub':'Products certified to international standards for EU & US market access',
