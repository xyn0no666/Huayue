window.APP_DATA_EN={
  ...
  testimonials:[
    {name:"Chen Zhiyuan",location:"Yantai, Shandong",avatar:"https://picsum.photos/seed/green-garden/200/200",text:"I run a large orchard and have been purchasing gasoline garden equipment from this factory. The machines deliver strong, consistent power — whether mowing, weeding, or clearing hillside land, they handle it all with ease. The build quality is solid and durable, fuel consumption is well controlled, and they run for hours without guzzling fuel. Simple to operate, low failure rate, and truly worry-free. I have reordered multiple times and recommended them to neighboring farmers.",rating:5},
    {name:"Zhao Minghui",location:"Hangzhou, Zhejiang",avatar:"https://picsum.photos/seed/forest-path/200/200",text:"Our municipal landscaping projects have been sourcing equipment from this factory long-term, and the overall quality exceeds expectations. The body construction uses quality materials, the engine starts smoothly without stalling, and noise and vibration are low during operation — workers do not fatigue easily even during long handheld shifts. The manufacturer provides responsive after-sales support with complete spare parts. Reliable partner — we will continue bulk purchasing.",rating:5},
    {name:"Lin Xiaoyu",location:"Shenzhen, Guangdong",avatar:"https://picsum.photos/seed/flower-meadow/200/200",text:"I have a large home garden that needs daily upkeep, and this equipment handles it all. The gasoline engine has strong burst power — hedge trimming, leaf clearing, weed removal, all in one machine. The lightweight body design means even I (a woman) can operate it easily. Stable quality, almost no failures in over half a year of use. Compared to similar products, the value for money is outstanding. Highly recommend.",rating:5},
    {name:"Sun Wenbo",location:"Yichun, Heilongjiang",avatar:"https://picsum.photos/seed/mountain-forest/200/200",text:"I mainly do land clearing in forest farms and mountainous areas with harsh conditions. This equipment is tough and durable, with excellent runtime — power stays strong even during extended high-intensity work. Simple to operate, older workers pick it up quickly, effectively reducing manual labor burden. An essential practical tool for mountain land clearing.",rating:5},
    {name:"Wang Jianjun",location:"Ningbo, Zhejiang",avatar:"https://picsum.photos/seed/nature-lake/200/200",text:"We run a private-label garden machinery brand with high standards for quality and brand image. Huayue customization capabilities are impressive — from colors to nameplates to packaging, everything is delivered exactly to spec with fast development cycles. Consistent quality over the years, timely supply, and reliable after-sales — a trustworthy long-term manufacturing partner.",rating:5},
    {name:"Ma Guoqiang",location:"Urumqi, Xinjiang",avatar:"https://picsum.photos/seed/desert-oasis/200/200",text:"Xinjiang has scorching summers and heavy dust — standard air filters just cannot cope. Huayue customized a heavy-duty air filter solution for us on their blowers and chainsaws, and the failure rate dropped dramatically. Responsive support, timely spare parts supply, smooth communication — very reassured with this partnership.",rating:5}
  ],
  faq:[
    {q:"How do I choose the right brush cutter model for my market?",a:"Model selection depends on lawn area, terrain, target market price positioning, and usage scenarios. Areas under 200m²: push mower recommended. 200-800m²: self-propelled. Over 800m²: ride-on. Our sales managers can provide professional advice tailored to your market needs.",cat:"产品选择"},
    ...
    {q:"What quality standards do your products meet?",a:"Our products are designed and manufactured to strict industry standards, with three quality control gates: incoming inspection, in-process patrol, and final full inspection. Each unit has a unique traceability code. We can provide relevant compliance documentation for customs clearance upon request. Factory visits welcome — 3 days free accommodation for new clients.",cat:"保修服务"},
    ...
    {q:"Where is the factory? Can I visit?",a:"Our factory is located 200m northeast of Leisure Fishing Garden, Luozhuang District, Linyi City, Shandong Province (east of Yinxing Road), covering 41,000m². Clients are welcome to schedule factory visits anytime.",cat:"经销商"},
