  ...
  function initFab(){
    ...
    var html='<div class="fab-stack">'+
      ...
      '<div class="fab-wechat-popover" id="fabWechatPop">'+
        '<div class="fab-wechat-popover__qr">微信扫码<br>添加好友</div>'+
        '<span>公众号：华悦园林机械</span>'+
      '</div>'+
      '<a href="mailto:export@huayueyuanlin.com" class="fab-btn fab-btn--email" aria-label="Email">'+
